...
// JPC - code to be used in New Journal Button and amended
...
var event_data = JSON.parse(document.getElementById('journal').innerHTML);

// JPC - replace with python monthly function
const months = [ 
    "January", 
    "February", 
    "March", 
